...
public class ListAlarmsCursorAdaptor extends SimpleCursorAdapter {
	...
	public ListAlarmsCursorAdaptor(Context context, int layout, Cursor c,
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		OnItemClickListener onItemClickListener = new OnItemClickListener(_id);

		View alarmSummary = (View) view.findViewById(R.id.alarm_summary);
		alarmSummary.setOnClickListener(onItemClickListener);
